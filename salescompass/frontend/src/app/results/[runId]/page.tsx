...
import { type ResultLoadError, useAnalysisResult } from "@/hooks/useAnalysisResult";
...
function ResultErrorState({ error }: { error: ResultLoadError }) {
  return (
...
function InlineResultError({ error }: { error: ResultLoadError }) {
  return (
